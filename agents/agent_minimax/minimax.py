...
def generate_move_minimax(
    ...
    action, _ = minimax(board, MINIMAX_DEPTH, player, True)
...
def minimax_alpha_beta_pruning(
    ...
    if MAXIMIZING:  # maximizing for player
        ...
        for column in valid_columns:
            ...
            _, new_score =  minimax_alpha_beta_pruning(c_board, depth-1, opponent, False, alpha, beta) ### maximizingTrue is False for next iter, because  will be oppnent
            if new_score > value:
                value = new_score
                best_column = column
        ...
        for column in valid_columns:
            ...
            _, new_score =  minimax_alpha_beta_pruning(c_board, depth-1, player, True, alpha, beta) ### maximizingTrue is True for next iter, because will be player
            if new_score < value:
                value = new_score
                best_column = column
...
def minimax(
    ...
    if MAXIMIZING:  # maximizing for player
        ...
        for column in valid_columns:
            c_board = apply_player_action(board, column, player, True) ### player
            _, new_score =  minimax(c_board, depth-1, opponent, False) ### maximizingTrue is False for next iter, because  will be oppnent
            if new_score > value:
                value = new_score
                best_column = column
        ...
        for column in valid_columns:
            c_board = apply_player_action(board, column, opponent, True) ### opponent is minimizing player
            _, new_score =  minimax(c_board, depth-1, player, True) ### maximizingTrue is True for next iter, because will be player
            if new_score < value:
                value = new_score
                best_column = column
            #print("after column", column, "best column is", best_column)
